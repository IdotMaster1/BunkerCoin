...
static const int64_t MAX_MONEY = 10000000000 * COIN; // Bunkercoin: maximum of 100B coins (given some randomness), max transaction 10,000,000,000
...
public:
    ...
    {
        // Bunkercoin: IsDust() detection disabled, allows any valid dust to be relayed.
