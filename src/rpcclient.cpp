...
std::string HelpMessageCli(bool mainProgram)
{
    ...
    if(mainProgram)
    {
        ...
        strUsage += "  -conf=<file>           " + _("Specify configuration file (default: bunkercoin.conf)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Connect to JSON-RPC on <port> (default: 22225 or testnet: 44555)") + "\n";
